  ...
  <div id="main">
    ...
    <div class="secend">
      <div class="secend_one">
        <p>
          <img src="../assets/img/21.png" alt width="15" height="14" /> 用户列表
        </p>
      </div>
      ...
      <div class="tab">
        ...
        >
          ...
          <el-table-column prop="user_id" label="用户D" align="center" width="85"></el-table-column>
          <el-table-column prop="weixin_name" label="微信呢称" align="center" width="125"></el-table-column>
          <el-table-column prop="phone_vip" label="会员手机" align="center"></el-table-column>
          <el-table-column label="注册时问" align="center">
            <template slot-scope="scope">{{ scope.row.date }}</template>
          </el-table-column>
          <el-table-column prop="lv" label="会员等级" align="center"></el-table-column>
          <el-table-column label="上次消费时问" align="center">
          ...
          <el-table-column prop="make" label="操作" show-overflow-tooltip width="155" align="center">
            <template slot-scope="scope">
              <el-button type="text" style="color:#9137f3;margin-right:10px;">编辑</el-button>
              <el-popover placement="left" width="320" v-model="scope.row.visible" transition="all 2s ease-in-out">
        ...
        <div style="margin-top: 20px">
          ...
          <template>
              <el-popover placement="right" width="320" v-model="visible1" transition="all 2s ease-in-out">
                <p style="float: left;">删除后无法恢复，确定删除？</p>
                <div style="text-align: right; margin: 0; float: right;">
  ...
  data() {
    return {
      ...
      tableData: [
        {
          user_id: "20182036",
          weixin_name: "爱吃阿司匹林的哺",
          phone_vip: "18854138769",
          date: "2019-01-2510:55",
          lv: "3",
          date2: "2019-03-2510:55",
          value2: 0,
          visible: false,
        },
        {
