    ...
    <div id="main">
        ...
        <div class="secend">
            <div class="secend_one">
                <p>
                    <img src="../assets/img/21.png" alt width="15" height="14" /> 活动列表
                </p>
                <div class="aniu">
                <el-button
                    type="primary"
            ...
            <div class="tab">
                ...
                >
                    ...
                    <el-table-column prop="titlie" label="标题" align="center" width="185"></el-table-column>
                    <el-table-column label="缩略图" align="center">
                        <template slot-scope="scope">
                        <img :src="scope.row.img" height="40" width="80" />
                        </template>
                    </el-table-column>
                    <el-table-column prop="state" label="活动状态" align="center"></el-table-column>
                    <el-table-column prop="price" label="报名费" align="center" width="80"></el-table-column>
                    ...
                    <el-table-column prop="make" label="操作" show-overflow-tooltip width="250" align="center">
                        <template>
                        ...
                        <template>
                        <el-button type="text" style="color:#9137f3" :plain="true" @click="open2">查看报名信息</el-button>
                        </template>
                    </el-table-column>
                </el-table>
